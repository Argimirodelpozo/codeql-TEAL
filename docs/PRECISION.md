...
36 detectors · 80 vulnerable + 115 safe ground-truth cases.
...
| `ir-tainted-fund-flow` | medium | high | 5 | 0 | 0 | 8 | 1.00 | 1.00 | 1.00 |
...
| **overall** | | | **80** | **0** | **0** | **115** | **1.00** | **1.00** | **1.00** |
