...
node in the graphs produced by :mod:`teal_graphs`. Instances of these
classes are what :mod:`teal_graphs` stores as the NetworkX node objects,
...
``teal/ql/lib/codeql/teal/ast/opcodes/``. Family classes
