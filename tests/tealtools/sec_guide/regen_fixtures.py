"""Regenerate the sec-guide fixture tree from `sec-guide-detections/`.

Each `.teal` file under `sec-guide-detections/<detection>/` (recursive)
...
`sec-guide-detections/`; missing DBs are then auto-built by the
