...
(`tealql.tealtools.dataflow.byte_taint`, `validate=True`), which tracks taint per
...
class. Sender/creator-gated sinks are suppressed (shared `tealql.security.common`
