...
behavioural divergences.** (Honest accounting: the then-current sampler,
`chain.sample_app_ids`, paginated from FIXED indexer cursors, so the five "overnight batches" re-fetched
