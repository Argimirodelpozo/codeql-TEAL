...
- `ir_partial_tainted_fund_flow.py` — the detector (extends `tealql.security._ir_taint_sink._IrTaintSinkDetector`, overriding the taint view and raw-findings hooks for byte-precise taint).
