...
36 detectors · 93 vulnerable + 129 safe ground-truth cases.
...
| --- | --- | --- | --: | --: | --: | --: | --: | --: | --: |
| `abi-method-selector` | medium | high | 1 | 0 | 0 | 2 | 1.00 | 1.00 | 1.00 |
...
| `ir-tainted-fund-flow` | medium | high | 12 | 0 | 0 | 11 | 1.00 | 1.00 | 1.00 |
...
| **overall** | | | **93** | **0** | **0** | **129** | **1.00** | **1.00** | **1.00** |
