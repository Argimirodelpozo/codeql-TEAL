...
class SSAProgram:
    ...
    # (single-element list pointing at the chain root). PySSA-wrapped
    # programs (via :func:`tealtools.ssa.wrap_as_ssa_program`) collapse
    # args to SSAVar leaves for fast iteration but keep an auxiliary
