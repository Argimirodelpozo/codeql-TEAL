...
- `ir_tainted_state_write.py` — the detector (extends `tealql.security._ir_taint_sink._IrTaintSinkDetector`, overriding `_raw_findings` to use the state-write flow function).
